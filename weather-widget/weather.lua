...
local WIDGET_DIR = HOME_DIR .. '/.config/awesome/modules/awesome-wm-widgets/weather-widget'
...
local LCLE = require("modules.awesome-wm-widgets.weather-widget.locale." .. LANG)
